...
class RegistryGui:
    ...
    def register_gui(self):
        ...
        self.list_tree["columns"] = ("first_name", "last_name", "phone", "email", "address")
        ...
        self.list_tree["displaycolumns"] = ("first_name", "last_name", "phone", "email", "address")
...
def open_file(filename):
    ...
    if os.path.exists(file_path):
        ...
        messagebox.showerror("Error", f"File '{filename}' not found in the current directory.")
